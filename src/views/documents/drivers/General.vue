      ...
      <div class="intro-y box p-5 mt-6">
        <div class="flex flex-col gap-6 mt-1">
          <div class="flex flex-col gap-2 items-end">
            <a href="/documents" class="flex items-center w-full px-3 py-2 rounded-md font-medium">
          ...
          <div class="flex flex-col gap-2 items-end" v-for="employeeDriver in employeeDrivers" :key="employeeDriver.id">
            <a href=""
              class="flex items-center w-full px-3 py-2 rounded-md font-medium border-t border-slate-200" v-bind:class = "employeeDriver.driver.id == driver_id ?'bg-primary text-white':'hover:bg-gray-100'" >
      ...
      <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
        <div class="w-full sm:w-auto relative mr-auto mt-3 sm:mt-0">
          <h2 class="intro-y pl-2 font-medium mr-auto mt-2">
            {{ $t("documents.current_folder_lbl") }} <span class="font-light">{{ driver_fullname }}/{{ $t("documents.general_files") }}</span>
          </h2>
        </div>
...
const { employeeDrivers, employeeDriver, getEmployeeDrivers, getEmployeeDriver } = useEmployeeDrivers();
      ...
      },      
      {
        ...
        formatter() {
          const a = dom(`<div class="flex lg:justify-center items-center">
            <a id="details_btn" class="flex items-center mr-3" href="javascript:;">
                  <i data-lucide="eye" class="w-4 h-4 mr-1"></i> Detalles
                </a>
...
onBeforeMount(async () => {
  ...
  await getEmployeeDriver(id);
  const driver = employeeDriver.value;
  console.log(driver);
  driver_fullname.value = driver.driver.name + " " + driver.driver.surname;
  driver_id.value = driver.driver.id;
