...
const fakers = {
  fakeUsers() {
    const users = [
      { name: "Conductor 1", gender: "male" },
      { name: "Conductor 2", gender: "male" },
      { name: "Conductor 3", gender: "male" },
      { name: "Conductor 4", gender: "male" },
      { name: "Conductor 5", gender: "male" },
      { name: "Conductor 6", gender: "male" },
      { name: "Conductor 7", gender: "male" },
      { name: "Conductor 8", gender: "female" },
      { name: "Conductor 9", gender: "male" },
      { name: "Conductor 10", gender: "male" },
      { name: "Conductor 11", gender: "male" },
      { name: "Conductor 12", gender: "male" },
      { name: "Conductor 13", gender: "male" },
      { name: "Conductor 14", gender: "female" },
      { name: "Conductor 15", gender: "male" },
    ];
