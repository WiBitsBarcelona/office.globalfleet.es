  ...
  <div class="intro-y box p-5 mt-0">
    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
      <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto">
        <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0 w-full">
          <label class="w-12 flex-none xl:w-auto xl:flex-initial mr-2 hidden">{{ $t("documents.filters.value") }}</label>
          <input id="tabulator-html-filter-value" v-model="filter.value" type="search"
            class="form-control sm:w-40 2xl:w-full mt-2 sm:mt-0 search-cancel"
        ...
        <div class="mb-5">
          <Dropzone ref-key="dropzoneMultipleRef" :options="{
            ...
            <div class="text-lg font-medium">
              Arrastra los ficheros a esta zona o haz click para seleccionarlos desde el explorador.
            </div>
            <div class="text-gray-600 mt-2">
              Versión demostración
              <span class="font-medium">NO</span> se envian ficheros al servidor.
            </div>
          </Dropzone>
        </div>
        <button type="button" @click="addFileModal = false" class="btn btn-primary w-24">
          Cerrar
        </button>
      </div>
    </ModalBody>
    ...
    columns: [
      ...
      },
      {
        ...
        formatterParams: {
          ...
          urlPrefix: "https://office-staging.globafleet.es/",
          target: "_blank",
        },
      },
      {
